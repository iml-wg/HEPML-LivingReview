...
myfile_out.write("This review was built with the help of the HEP-ML community, the [INSPIRE REST API](https://github.com/inspirehep/rest-api-doc), and the moderators Ben Nachman, Matthew Feickert, Claudius Krause, and Ramon Winterhalder.\n\n")
