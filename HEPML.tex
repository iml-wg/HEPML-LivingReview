...
\begin{itemize}
\item Reviews~\cite{Larkoski:2017jix,Guest:2018yhq,Albertsson:2018maf,Radovic:2018dip,Carleo:2019ptp,Kasieczka:2019dbj} and old(er) uses of machine learning~\cite{Denby:1987rk,Lonnblad:1990bi}.
\item Classification.  See also parameterized classifiers~\cite{Baldi:2016fzo,Cranmer:2015bka}.
	\begin{itemize}
		\item Representations
			\begin{itemize}
				...
				\item Graphs~\cite{Henrion:DLPS2017,Ju:2020xty,Martinez:2018fwc,Moreno:2019bmu,Qasim:2019otl,Chakraborty:2019imr,Chakraborty:2020yfc}
		...
		\item Targets
			...
			\item quarks and gluons~\cite{ATL-PHYS-PUB-2017-017,Komiske:2016rsd,Cheng:2017rdo,Stoye:DLPS2017,Moreno:2019bmu,Kasieczka:2018lwf}
			...
			\item $b$-tagging~\cite{Sirunyan:2017ezt,Guest:2016iqz}
			\item BSM particles~\cite{Datta:2019ndh,Baldi:2014kfa,Chakraborty:2019imr,Sirunyan:2019nfw}
			\item Particle identification~\cite{deOliveira:2018lqd,Paganini:DLPS2017,Hooberman:DLPS2017,Belayneh:2019vyx,Qasim:2019otl}
			\item Neutrino Detectors~\cite{Adams:2018bvi,Aurisano:2016jvx,Acciarri:2016ryt,Hertel:DLPS2017}
			\item Tracking~\cite{Farrell:DLPS2017,Farrell:2018cjr,Amrouche:2019wmx,Ju:2020xty}
			\item Heavy ions~\cite{Pang:2016vdc}
		\end{itemize}
		\item Learning strategies
			\begin{itemize}
				\item Weak supervision~\cite{Dery:2017fap,Metodiev:2017vrx,Komiske:2018oaa,Collins:2018epr,Collins:2019jip,Borisyak:2019vbz,Cohen:2017exh,Komiske:2018vkc,Metodiev:2018ftz}
				\item Unsupervised~\cite{Mackey:2015hwa,Komiske:2019fks}
			\end{itemize}
		\item Fast inference
			\begin{itemize}
				\item Software~\cite{Strong:2020mge,Gligorov:2012qt,Weitekamp:DLPS2017,Bourgeois:2018nvk}
...
\item Anomaly detection
	\begin{itemize}
		\item Fully signal model-independent, fully background model-dependent~\cite{sleuth,Abbott:2000fb,Abbott:2000gx,Abbott:2001ke,Aaron:2008aa,Aktas:2004pz,Cranmer:2005zn,Aaltonen:2007dg,Aaltonen:2007ab,Aaltonen:2008vt,CMS-PAS-EXO-14-016,CMS-PAS-EXO-10-021,Aaboud:2018ufy,ATLAS-CONF-2014-006,ATLAS-CONF-2012-107,DAgnolo:2018cun,DAgnolo:2019vbw}
		\item Partially signal model-dependent, partially background model-dependent~\cite{Farina:2018fyg,Heimel:2018mkt,Roy:2019jae,Cerri:2018anq,Blance:2019ibf,Hajer:2018kqm,Collins:2018epr,Collins:2019jip,DeSimone:2018efk,Mullin:2019mmh,1809.02977,Dillon:2019cqt,Andreassen:2020nkr,Aguilar-Saavedra:2017rzt,Romao:2019dvs}
	\end{itemize}
\item Simulation-based (`likelihood-free') Inference (Overview:~\cite{Cranmer:2019eaq})
	\begin{itemize}
...
\item Experimental results. \textit{This section is incomplete as there are many results that directly and indirectly (e.g. via flavor tagging) use modern machine learning techniques.  We will try to highlight experimental results that use deep learning in a critical way for the final analysis sensitivity.}
	\begin{itemize}
		\item Final analysis discriminate for searches~\cite{Aad:2019yxi,Aad:2020hzm}.
	\end{itemize}
