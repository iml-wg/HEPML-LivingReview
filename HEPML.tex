...
\item Reviews.
	\begin{itemize}
		...
		\item Specialized reviews~\cite{Kasieczka:2019dbj,1807719,1808887,Psihas:2020pby,Butter:2020tvl}
...
\item Classification.
	\begin{itemize}
		...
		\item Representations
			\begin{itemize}
				\item Jet images~\cite{Pumplin:1991kc,Cogan:2014oua,Almeida:2015jua,deOliveira:2015xxd,ATL-PHYS-PUB-2017-017,Lin:2018cin,Komiske:2018oaa,Barnard:2016qma,Komiske:2016rsd,Kasieczka:2017nvn,Macaluso:2018tck}
				...
				\item Graphs~\cite{Henrion:DLPS2017,Ju:2020xty,Martinez:2018fwc,Moreno:2019bmu,Qasim:2019otl,Chakraborty:2019imr,Chakraborty:2020yfc,1797439,1801423,1808887,Iiyama:2020wap,1811770,Choma:2020cry}
				\item Sets (point clouds)~\cite{Komiske:2018cqr,Qu:2019gqs,Shlomi:2020ufi}
		...
		\item Targets
			...
			\item Neutrino Detectors~\cite{Adams:2018bvi,Aurisano:2016jvx,Acciarri:2016ryt,Hertel:DLPS2017,Aiello:2020orq,Adams:2020vlj,Domine:2020tlx,1805474,1808859,Psihas:2020pby}
...
\item Regression.
	\begin{itemize}
		...
		\item Matrix elements~\cite{Bishara:2019iwh,1804325}
