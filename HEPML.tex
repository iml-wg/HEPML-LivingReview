...
\item Reviews.
	\begin{itemize}
		...
		\item Specialized reviews~\cite{Kasieczka:2019dbj,1807719,1808887,Psihas:2020pby,Butter:2020tvl,Forte:2020yip,Brehmer:2020cvb}
...
\item Classification.
	\begin{itemize}
		...
		\item Targets
			...
			\item top quark tagging~\cite{Almeida:2015jua,Stoye:DLPS2017,Kasieczka:2019dbj,Chakraborty:2020yfc,Diefenbacher:2019ezd,Butter:2017cot,Kasieczka:2017nvn,Macaluso:2018tck,Bhattacharya:2020vzu}
			...
			\item Neutrino Detectors~\cite{Adams:2018bvi,Aurisano:2016jvx,Acciarri:2016ryt,Hertel:DLPS2017,Aiello:2020orq,Adams:2020vlj,Domine:2020tlx,1805474,1808859,Psihas:2020pby,alonsomonsalve2020graph,Abratenko:2020pbp}
		...
		\item Learning strategies
			\begin{itemize}
				...
				\item Quantum Machine Learning~\cite{Blance:2020nhl,Terashi:2020wfi,Mott:2017xdb}
			\end{itemize}
