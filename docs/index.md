...
??? example "Datasets"
    ...
    * [NuBench: An Open Benchmark for Deep Learning-Based Event Reconstruction in Neutrino Telescopes](https://arxiv.org/abs/2511.13111) (2025)
    * [wa-hls4ml: A Benchmark and Surrogate Models for hls4ml Resource and Latency Estimation](https://arxiv.org/abs/2511.05615) (2025)
...
??? example "Targets"
    ...
    * [Deep-learning jet flavor tagging for precision hadronic Higgs measurements at future $e^+e^-$ Higgs factories](https://arxiv.org/abs/2512.21558) (2025)
    * [E-PCN: Jet Tagging with Explainable Particle Chebyshev Networks Using Kinematic Features](https://arxiv.org/abs/2512.07420) (2025)
    ...
    * [Observability of an ultraheavy diquark decaying into vectorlike quarks at the LHC](https://arxiv.org/abs/2511.02474) (2025)
    ...
    * [Measurement of solar neutrino interaction rate below 3.49 MeV in Super-Kamiokande-IV](https://arxiv.org/abs/2512.19887) (2025)
    * [Data-Driven Calibration of Large Liquid Detectors with Unsupervised Learning](https://arxiv.org/abs/2512.17866) (2025)
    ...
    * [MiniFool -- Physics-Constraint-Aware Minimizer-Based Adversarial Attacks in Deep Neural Networks](https://arxiv.org/abs/2511.01352) (2025)
    ...
    * [Searching for EeV photons with Telescope Array Surface Detector and neural networks](https://arxiv.org/abs/2512.01638) (2025)
    * [Physics-informed continuous normalizing flows to learn the electric field within a time-projection chamber](https://arxiv.org/abs/2511.01897) (2025)
    ...
    * [Learning to Reconstruct: A Differentiable Approach to Muon Tracking at the LHC](https://arxiv.org/abs/2512.01647) (2025)
    * [Locality-Sensitive Hashing-Based Efficient Point Transformer for Charged Particle Reconstruction](https://arxiv.org/abs/2510.07594) (2025)
    ...
    * [Quantifying vacuum-like jets in heavy-ion collisions: a Machine Learning study](https://arxiv.org/abs/2511.10724) (2025)
    * [Physics-informed neural network (PINN) modeling of charged particle multiplicity using the two-component framework in heavy-ion collisions: A comparison with data-driven neural networks](https://arxiv.org/abs/2511.05186) (2025)
    * [Validating a Machine Learning Approach to Identify Quenched Jets in Heavy-Ion Collisions](https://arxiv.org/abs/2511.04005) (2025)
...
??? example "Learning strategies"
    ...
    * [Optimal Transport Event Representation for Anomaly Detection](https://arxiv.org/abs/2512.04839) (2025)
    ...
    * [Data-Driven Calibration of Large Liquid Detectors with Unsupervised Learning](https://arxiv.org/abs/2512.17866) (2025)
    * [An interpretable unsupervised representation learning for high precision measurement in particle physics](https://arxiv.org/abs/2511.22246) (2025)
    ...
    * [From Qubits to Couplings: A Hybrid Quantum Machine Learning Framework for LHC Physics](https://arxiv.org/abs/2511.15672) (2025)
    * [QINNs: Quantum-Informed Neural Networks](https://arxiv.org/abs/2510.17984) (2025)
    * [Continuous-variable photonic quantum extreme learning machines for fast collider-data selection](https://arxiv.org/abs/2510.13994) (2025)
    * [Search for $t\bar tt\bar tW$ Production at $\sqrt{s}](https://arxiv.org/abs/2507.23723) (2025)
...
??? example "Fast inference / deployment"
    ...
    * [BOA Constrictor: A Mamba-based lossless compressor for High Energy Physics data](https://arxiv.org/abs/2511.11337) (2025)
...
??? example "Calibration"
    ...
    * [Machine learning techniques for jet reconstruction at LHCb and application to the search for $H \to b \bar{b}$ and $H \to c \bar{c}$ in $\sqrt{s}](https://arxiv.org/abs/2601.16802) (2026)
    * [Improving Neutrino Oscillation Measurements through Event Classification](https://arxiv.org/abs/2511.11938) [[DOI](https://doi.org/10.1103/zqmw-rvn1)] (2025)
    * [Design and Expected Performance for an hKLM at the EIC](https://arxiv.org/abs/2511.08432) (2025)
    * [Neural Fake Factor Estimation Using Data-Based Inference](https://arxiv.org/abs/2511.06972) (2025)
...
??? example "Recasting"
    ...
    * [Accelerated Sequential Posterior Inference via Reuse for Gravitational-Wave Analyses](https://arxiv.org/abs/2511.04218) (2025)
...
??? example "Matrix elements"
    ...
    * [Amplitude Surrogates for Multi-Jet Processes](https://arxiv.org/abs/2512.11036) (2025)
...
??? example "Parton Distribution Functions (and related)"
    ...
    * [Quantitative Understanding of PDF Fits and their Uncertainties](https://arxiv.org/abs/2512.24116) (2025)
...
??? example "Lattice Gauge Theory"
    ...
    * [AI for Pattern Hunter: Application in Wilson Loop of 2D Lattice Yang-Mills Theory](https://arxiv.org/abs/2510.24494) (2025)
    * [A Unified Neural-Network Framework for Nucleon Imaging from Numerical Simulations of QCD](https://arxiv.org/abs/2509.15931) (2025)
...
??? example "Symbolic Regression"
    ...
    * [Machine Learning the Conformal Manifold of Holographic CFT$_{2}$s](https://arxiv.org/abs/2511.02981) (2025)
...
??? example "(Continuous) Normalizing flows"
    ...
    * [Computing quantum entanglement with machine learning](https://arxiv.org/abs/2512.11389) (2025)
    * [Data-Driven Predictions for Dark Photon and Millicharged Particle Production](https://arxiv.org/abs/2512.04153) (2025)
...
??? example "Transformer Models"
    ...
    * [Learning the Inverse Ryu--Takayanagi Formula with Transformers](https://arxiv.org/abs/2511.06387) (2025)
    * [Fast, accurate, and precise detector simulation with vision transformers](https://arxiv.org/abs/2509.25169) (2025)
...
??? example "Evaluation of Generative Models"
    ...
    * [SURFing to the Fundamental Limit of Jet Tagging](https://arxiv.org/abs/2511.15779) (2025)
    * [Learning to Validate Generative Models: a Goodness-of-Fit Approach](https://arxiv.org/abs/2511.09118) (2025)
...
??? example "Anomaly detection."
    ...
    * [How to pick the best anomaly detector?](https://arxiv.org/abs/2511.14832) (2025)
...
??? example "Foundation Models, LLMs, Agents."
    ...
    * [Enhancing next token prediction based pre-training for jet foundation models](https://arxiv.org/abs/2512.04149) (2025)
...
??? example "ML for theory"
    ...
    * [Learning holographic QCD with unflavoured meson spectra](https://arxiv.org/abs/2512.16450) (2025)
    * [AdS/Deep-Learning made easy II: neural network-based approaches to holography and inverse problems](https://arxiv.org/abs/2511.22522) (2025)
    * [Phase structure of 2+1-flavor QCD from an Einstein-dilaton-flavor holographic model](https://arxiv.org/abs/2511.19127) (2025)
    * [Fermions and Supersymmetry in Neural Network Field Theories](https://arxiv.org/abs/2511.16741) (2025)
    * [Good flavor search in $SU(5)$: a machine learning approach](https://arxiv.org/abs/2511.08154) (2025)
    * [Learning the Inverse Ryu--Takayanagi Formula with Transformers](https://arxiv.org/abs/2511.06387) (2025)
    * [Machine Learning the Conformal Manifold of Holographic CFT$_{2}$s](https://arxiv.org/abs/2511.02981) (2025)
    * [Spectral functions in Minkowski quantum electrodynamics from neural reconstruction: Benchmarking against dispersive Dyson--Schwinger integral equations](https://arxiv.org/abs/2510.24728) (2025)
    * [Uncovering Singularities in Feynman Integrals via Machine Learning](https://arxiv.org/abs/2510.10099) (2025)
...
??? example "Final analysis discriminate for searches"
    ...
    * [Measurement of solar neutrino interaction rate below 3.49 MeV in Super-Kamiokande-IV](https://arxiv.org/abs/2512.19887) (2025)
    * [Search for black holes and sphalerons using novel machine learning techniques at CMS](https://arxiv.org/abs/2511.10662) (2025)
    * [Wasserstein normalized autoencoder for anomaly detection](https://arxiv.org/abs/2510.02168) (2025)
...
??? example "Measurements using deep learning directly (not through object reconstruction)"
    ...
    * [Determination of the HERA coherent diffractive $J/ψ$ production cross section via artificial neural network](https://arxiv.org/abs/2512.21704) (2025)
