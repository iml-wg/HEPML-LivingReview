...
??? example "Modern reviews"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
    ### Modern reviews
    </div>
...
## Classification
??? note "Parameterized classifiers"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Targets"
    ...
    - [Boosted decision trees approach to neck alpha events discrimination in DEAP-3600 experiment](https://doi.org/10.1088/1402-4896/ab8dff)
...
??? note "Fast inference / deployment"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Parton Distribution Functions (and related)"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Decorrelation methods"
    ...
    - [Convolved Substructure: Analytically Decorrelating Jet Substructure Observables](https://doi.org/{10.1007/JHEP05(2018)002)
...
??? note "Differentiable Simulation"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Uncertainty   - and inference-aware learning"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Searches and measurements were ML reconstruction is a core component"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Final analysis discriminate for searches"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
...
??? note "Measurements using deep learning directly (not through object reconstruction)"
    <div class="meta_for_parser tablespecs" style="font-size: 1pt;visibility:hidden" markdown>
